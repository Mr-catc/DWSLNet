...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.resnet50_2 = resnet50.resnet50(pretrained=True, use_MARS=True, strides=(2, 2, 2, 1))
    ...
    def trainable_parameters(self):
        ...
        return (
         list(self.backbone2.parameters()), list(self.newly_added.parameters()))
...
class CAM(Net):
    ...
    def forward(self, x):
        ...
        x2 = F.conv2d(x2, self.classifier.weight)
        x2 = F.relu(x2)
        x2 = x[0] + x2[1].flip(-1)
        return x, x2
